...
def train_binary(
    *,
    ...
    train_dl = DataLoader(train_ds, batch_size=int(batch_size), shuffle=True, drop_last=True, **dl_common)
    ...
    sched = torch.optim.lr_scheduler.CosineAnnealingLR(opt, T_max=int(epochs), eta_min=float(lr) * 0.05)
